...
export default function Ecstacy() {
    return (
        <div className={styles.container}>
            <div>  
                    <h1 className={styles.header}>Ecstacy</h1>
            </div>
            ...
            <div className={styles.maininfocontainer}>
                ...
                <ul className={styles.listmain}>
                    ...
                    <li data-icon="💊 " className={styles.listitemtext}>Ecstacy produces feelings of increased energy, pleasure, emotional warmth, and a distorted sense of time perception and sensory inputs. </li>
