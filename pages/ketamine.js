    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.riskscontainer}>
                ...
                <p className={styles.risksmain}>Use can cause unconsciousness, high blood presure, and dangerously slowed breathing in the short term. In the long term it can cause ulcers, pain in the bladder, kidney problems, stomach pain, depression, and poor memory.</p> 
            </div>
            <Footer />
